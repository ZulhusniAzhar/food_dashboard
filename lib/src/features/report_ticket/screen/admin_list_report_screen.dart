                            ...
                            Obx(
                              () => Column(
                                ...
                                children: reportController
                                    .getUniqueMonthsAdmin()
                                    .map((monthYear) {
                                  List<ReportTicketModel> reportsForMonth =
                                      reportController
                                          .getReportsByMonthAdminIntervention(
                                              monthYear);
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: reportController
                                    .getUniqueMonthsOngoing()
                                    .map((monthYear) {
                                  List<ReportTicketModel>
                                      reportsForMonthOngoing = reportController
                                          .getReportsByMonthOngoing(monthYear);
